...
<ol>
  ...
  <li>  💻 **Հմտություններ:** React, Next.js, JavaScript, Node.js, Tailwind CSS, PHP, Databases  </ul>  
  <li>  📚 **Նպատակ:** Ստեղծել արագ, մատչելի եւ user-friendly վեբ հավելվածներ  </ul>  
  <li>  🌍 **Աշխատանքի որոնում եմ**՝ որպես **Junior Full-Stack Developer**  </ul>  
  <li>  📩 **Բաց եմ համագործակցության համար!**  </ul>  
</ol>
