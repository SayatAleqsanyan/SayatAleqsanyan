...
<ul>
  <li>  🎨 **Full-Stack ծրագրավորող եմ**, ով սիրում է զբաղվել UI/UX դիզայնով եւ back-end լուծումներով  </li>  
  <li>  💻 **Հմտություններ:** React, Next.js, JavaScript, Node.js, Tailwind CSS, PHP, Databases  </li>  
  <li>  📚 **Նպատակ:** Ստեղծել արագ, մատչելի եւ user-friendly վեբ հավելվածներ  </li>  
  <li>  🌍 **Աշխատանքի որոնում եմ**՝ որպես **Junior Full-Stack Developer**  </li>  
  <li>  📩 **Բաց եմ համագործակցության համար!**  </li>  
</ul>
...
### Full-Stack Development Course - BeeOnCode  **7 ամիս**  
